...
2)DML - stands for data manupultion language
    1)inset value



    2)update data : update data form tables

        syntax : update tablename set column1=

    3)delete data:
            1)delete all data 
            syntex : delete from tbl_name;
            2) delete particualr data 
            syntex : delete from tbl_name where user_id=1;
                    or  
                    delete from tbl_name where name ='brijesh';
            3) delete from tbl_name where user_id in (1,2);
            4) data from tbl_name 